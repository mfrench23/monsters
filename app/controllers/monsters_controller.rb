class MonstersController < ApplicationController
  ...
  private
    ...
    def monster_params
      params.require(:monster).permit(:strength, :dexterity, :intelligence, :health, :hitPoints, :will, :perception, :fatigue, :speed, :sizeModifier, :height, :weight, :gear, :description, :notes, :dodge, :block)
    end
end
