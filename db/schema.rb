...
ActiveRecord::Schema.define(version: 20171130000249) do
  ...
  add_index "damage_resistances", ["monster_id"], name: "fk_rails_bbd5ada780", using: :btree
  ...
  add_index "equipment_packages", ["monster_id"], name: "fk_rails_2939885056", using: :btree
  ...
  add_index "parry_scores", ["monster_id"], name: "fk_rails_7dbac8db85", using: :btree
  ...
  add_index "skills", ["monster_id"], name: "fk_rails_ce9ca53097", using: :btree
  ...
  add_index "traits", ["monster_id"], name: "fk_rails_fbfded9973", using: :btree
