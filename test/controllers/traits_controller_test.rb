...
class TraitsControllerTest < ActionController::TestCase
  ...
  test "should create trait" do
    assert_difference('Trait.count') do
      post :create, trait: { description: @trait.description, is_feature: @trait.is_feature, level: @trait.level, monster_id: @trait.monster_id, name: @trait.name }
    end
  ...
  test "should update trait" do
    patch :update, id: @trait, trait: { description: @trait.description, is_feature: @trait.is_feature, level: @trait.level, monster_id: @trait.monster_id, name: @trait.name }
    assert_redirected_to trait_path(assigns(:trait))
  end
