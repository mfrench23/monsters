...
class RpmRitualsControllerTest < ActionController::TestCase
  ...
  test "should get pdf" do
    get :full_book, params: { :format => "pdf" }
  ...
  test "should get duplicate" do
    get :duplicate, params: { id: @rpm_ritual }
    assert_response :success
  ...
  test "should create rpm_ritual" do
    ...
    assert_difference('RpmRitual.count') do
      post :create, params: { rpm_ritual: { campaign_id: @rpm_ritual.campaign_id, name: name, typical_cost: @rpm_ritual.typical_cost } }
    end
  ...
  test "should show rpm_ritual" do
    get :show, params: { id: @rpm_ritual }
    assert_response :success
  end

  test "should get edit" do
    get :edit, params: { id: @rpm_ritual }
    assert_response :success
  end

  test "should update rpm_ritual" do
    patch :update, params: { id: @rpm_ritual, rpm_ritual: { campaign_id: @rpm_ritual.campaign_id, description: @rpm_ritual.description, name: @rpm_ritual.name, typical_cost: @rpm_ritual.typical_cost } }
    assert_redirected_to @rpm_ritual
  end
  ...
  test "should destroy rpm_ritual" do
    ...
    assert_difference('RpmRitual.count', -1) do
      delete :destroy, params: { id: @rpm_ritual }
    end
