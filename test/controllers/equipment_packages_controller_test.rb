...
class EquipmentPackagesControllerTest < ActionController::TestCase
  setup do
    @equipment_package = FactoryBot.create(:equipment_package)
  end
  ...
  test "should show equipment_package" do
    get :show, params: { id: @equipment_package }
    assert_response :success
  end

  test "should get edit" do
    get :edit, params: { id: @equipment_package }
    assert_response :success
  end

  test "should update equipment_package" do
    patch :update, params: { id: @equipment_package, equipment_package: { name: @equipment_package.name + "2", notes: @equipment_package.notes.to_s + "\nJust adding some notes here.\n" } }
  ...
  test "should destroy equipment_package" do
    ...
    assert_difference('EquipmentPackage.count', -1) do
      delete :destroy, params: { id: @equipment_package }
    end
