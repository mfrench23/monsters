...
class EquipmentPiecesHelperTest < ActionView::TestCase
  test "should correctly format individual items" do
    ...
    assert_equal "Mini-Excalibur: Knife (Extra-Fine; Fine; 1#, $15.00)", pretty_print_equipment_piece(ep)
    ep.quantity = 3
    assert_equal "Mini-Excalibur: 3 Knives (Extra-Fine; Fine; each 1#, $15.00; total 3#, $45.00)", pretty_print_equipment_piece(ep)
  end
